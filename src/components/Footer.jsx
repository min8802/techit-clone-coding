    ...
    return (
      <footer className="mt-20 lg:mt-40 border-t border-techit-gray-100">
        <div className="container-style px-6 py-8">
            ...
            <div className="flex justify-between max-w-[300px] w-full">
              ...
              <div>
                ...
                <nav className="flex flex-col text-sm font-semibold gap-3 mt-4">
                    ...
                    <button className="text-left flex items-center gap-1">LIKELION
                    ...
                    <button className="text-left flex items-center gap-1">채용
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-6">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" 
                        d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"></path></svg>
                    </button>
          ...
          <div className="mt-12 border-t border-techit-gray-100 text-techit-gray-200 text-xs">
            <nav className="flex gap-3 mt-4 mb-4">
                {iconsData.map((v,i) => (<SocialIcon key={i} image={v}/>))}
            </nav>
            <div className="flex items-center gap-2 text-techit-gray-200 text-xs">
                이용약관
